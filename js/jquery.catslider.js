  ...
  $.CatSlider.prototype = {
    ...
    showCategory : function( catidx ) {
      ...
      var dir = catidx > this.current ? 'right' : 'left',
        toClass = dir === 'right' ? 'mi-moveToLeft super-menu-list ristretto-font' : 'mi-moveToRight super-menu-list ristretto-font',
        fromClass = dir === 'right' ? 'mi-moveFromRight super-menu-list ristretto-font' : 'mi-moveFromLeft super-menu-list ristretto-font',
        // Текущая категория
